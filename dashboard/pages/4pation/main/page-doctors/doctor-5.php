    ...
    <main>
        ...
        <article>
            <div class="main-info" style="position: relative;">
                <p>Запись к врачу <strong>Эндокринолог</strong> - Нестерова Инна Ивановна</p>
                <div class="mi-date">
                    <div class="mid-day">
                        <form action="push/push-appoint-5.php" method="post" class="timegrid">
                            ...
                            <?php
                                ...
                                if($freedate = $datenow) {
                                    $test = mysqli_query($link, "SELECT * FROM `timework-5` LEFT JOIN `appointment-5` ON `appointment-5`.`timeticket`=`timework-5`.`time` WHERE `appointment-5`.`timeticket` IS NULL");
