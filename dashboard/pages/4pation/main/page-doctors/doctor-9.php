    ...
    <main>
        ...
        <article>
            <div class="main-info" style="position: relative;">
                <p>Запись к врачу <strong>ЛОР</strong> - Патока Алексей Федорович</p>
                <div class="mi-date">
                    <div class="mid-day">
                        <form action="push/push-appoint-9.php" method="post" class="timegrid">
                            ...
                            <?php
                                ...
                                if($freedate = $datenow) {
                                    $test = mysqli_query($link, "SELECT * FROM `timework-9` LEFT JOIN `appointment-9` ON `appointment-9`.`timeticket`=`timework-9`.`time` WHERE `appointment-9`.`timeticket` IS NULL");
