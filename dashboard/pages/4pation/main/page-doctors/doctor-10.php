    ...
    <main>
        ...
        <article>
            <div class="main-info" style="position: relative;">
                <p>Запись к врачу <strong>Гастроэнтеролог</strong> - Серебряков Игорь Николаевич</p>
                <div class="mi-date">
                    <div class="mid-day">
                        <form action="push/push-appoint-10.php" method="post" class="timegrid">
                            ...
                            <?php
                                ...
                                if($freedate = $datenow) {
                                    $test = mysqli_query($link, "SELECT * FROM `timework-10` LEFT JOIN `appointment-10` ON `appointment-10`.`timeticket`=`timework-10`.`time` WHERE `appointment-10`.`timeticket` IS NULL");
