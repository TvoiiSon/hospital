    ...
    <main>
        ...
        <article>
            <div class="main-info" style="position: relative;">
                <p>Запись к врачу <strong>Врач УЗИ</strong> - Воробьёва Татьяна Владимировна</p>
                <div class="mi-date">
                    <div class="mid-day">
                        <form action="push/push-appoint-4.php" method="post" class="timegrid">
                            ...
                            <?php
                                ...
                                if($freedate = $datenow) {
                                    $test = mysqli_query($link, "SELECT * FROM `timework-4` LEFT JOIN `appointment-4` ON `appointment-4`.`timeticket`=`timework-4`.`time` WHERE `appointment-4`.`timeticket` IS NULL");
