    ...
    <main>
        ...
        <article>
            <div class="main-info" style="position: relative;">
                <p>Запись к врачу <strong>Терапевт</strong> - Курыгина Лариса Николаевна</p>
                <div class="mi-date">
                    <div class="mid-day">
                        <form action="push/push-appoint-6.php" method="post" class="timegrid">
                            ...
                            <?php
                                ...
                                if($freedate = $datenow) {
                                    $test = mysqli_query($link, "SELECT * FROM `timework-6` LEFT JOIN `appointment-6` ON `appointment-6`.`timeticket`=`timework-6`.`time` WHERE `appointment-6`.`timeticket` IS NULL");
