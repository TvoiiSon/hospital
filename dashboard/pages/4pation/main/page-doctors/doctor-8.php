    ...
    <main>
        ...
        <article>
            <div class="main-info" style="position: relative;">
                <p>Запись к врачу <strong>Пульмонолог</strong> - Шанько Наталья Владимировна</p>
                <div class="mi-date">
                    <div class="mid-day">
                        <form action="push/push-appoint-8.php" method="post" class="timegrid">
                            ...
                            <?php
                                ...
                                if($freedate = $datenow) {
                                    $test = mysqli_query($link, "SELECT * FROM `timework-8` LEFT JOIN `appointment-8` ON `appointment-8`.`timeticket`=`timework-8`.`time` WHERE `appointment-8`.`timeticket` IS NULL");
