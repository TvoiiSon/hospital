...
$query = "INSERT INTO `appointment-7` (`identcode`, `fiodoctor`, `fiopation`, `idpation`, `direction`, `date`, `timeticket`, `free`) VALUES ('$identcode', '$docidcl', '$patidcl', '$userid', '$docdircl', '$datedayago', '$idtime', '$free')";
