    ...
    <main>
        ...
        <article>
            <div class="main-info" style="position: relative;">
                <p>Запись к врачу <strong>Невролог</strong> - Куликова Ольга Михайловна</p>
                <div class="mi-date">
                    <div class="mid-day">
                        <form action="push/push-appoint-7.php" method="post" class="timegrid">
                            ...
                            <?php
                                ...
                                if($freedate = $datenow) {
                                    $test = mysqli_query($link, "SELECT * FROM `timework-7` LEFT JOIN `appointment-7` ON `appointment-7`.`timeticket`=`timework-7`.`time` WHERE `appointment-7`.`timeticket` IS NULL");
